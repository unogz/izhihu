...
var pi={}
  ...
  , ipic=_p.indexOf('/collection')
  , ipias=_p.indexOf('/answers')
;
pi.h='/'==_p;
...
function f_a($a){
    ...
    if($p.length){//relocatePersonInfo
        ...
        if($a.length){
            var $ppla=$('<a></a>').attr('href','#'+$a.attr('data-aid'))
...
*/
    ...
    if(pi.c){
        $('<span class="zg-bull">•</span>').appendTo('#zh-list-meta-wrap');
        $('<a/>',{
            name:'getLinks'
          , href:'javascript:;'
          , html:'获取网址'
        }).click(function(){
        }).appendTo('#zh-list-meta-wrap');
        var f=$('<textarea/>',{
            id:'aGetLinks'
