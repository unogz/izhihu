...
if(typeof window.iZhihu4CRX === 'undefined' || !window.iZhihu4CRX){
    ...
    function autoUpdateFromUserscriptsDotOrg(SCRIPT) {
      ...
      try {
        ...
        var isSomeoneChecking = utils.getValue('CHECKING', null);
        var now = new Date().getTime();
        //utils.setValue('CHECKING', now.toString());
        ...
        var lastChecked = utils.getValue('LAST_CHECKED', null);
    ...
    GM_xmlhttpRequest({
      method: 'GET',
        ...
        //utils.setValue('LAST_CHECKED', now.toString());
      } catch (ex) {
          console.log(ex);
      }
    }
